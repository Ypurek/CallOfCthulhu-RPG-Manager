(function () {
    ...
    function initCharacterCreatePage() {
        ...
        const WIZ_I18N = {
            noWeapons: config.dataset.noWeapons || 'No weapons added.',
            noCombatSkill: config.dataset.noCombatSkill || 'No combat skill',
            preparedBadge: config.dataset.preparedBadge || 'Prepared',
            defaultBadge: config.dataset.defaultBadge || 'Default',
            weaponFallback: config.dataset.weaponFallback || 'Weapon',
            addCustomSkill: config.dataset.addCustomSkill || 'Add Custom Skill',
            addSkillHelp: config.dataset.addSkillHelp || '',
            addSkill: config.dataset.addSkill || 'Add Skill',
            renameCustomSkill: config.dataset.renameCustomSkill || 'Rename Custom Skill',
            renameSkillHelp: config.dataset.renameSkillHelp || '',
            updateSkill: config.dataset.updateSkill || 'Update Skill',
            enterSkillName: config.dataset.enterSkillName || 'Please enter a skill name',
            skillContainerNotFound: config.dataset.skillContainerNotFound || 'Skill container not found',
            baseValue: config.dataset.baseValue || 'base',
            renameSkillTitle: config.dataset.renameSkillTitle || 'Rename custom skill',
            removeSkillTitle: config.dataset.removeSkillTitle || 'Remove custom skill',
            editWeapon: config.dataset.editWeapon || 'Edit Weapon',
            saveWeapon: config.dataset.saveWeapon || 'Save',
            addWeapon: config.dataset.addWeapon || 'Add Weapon',
            addWeaponBtn: config.dataset.addWeaponBtn || 'Add',
            unarmedBrawl: config.dataset.unarmedBrawl || 'Unarmed Brawl',
            statDescriptions: {
                STR: config.dataset.statDescStr || '',
                CON: config.dataset.statDescCon || '',
                DEX: config.dataset.statDescDex || '',
                INT: config.dataset.statDescInt || '',
                POW: config.dataset.statDescPow || '',
                SIZ: config.dataset.statDescSiz || '',
                APP: config.dataset.statDescApp || '',
                EDU: config.dataset.statDescEdu || '',
                LCK: config.dataset.statDescLck || '',
            },
        };
