...
def scenario_npc_create(request, scenario_id):
    ...
    hp = int(request.POST.get("npc_hp", 10) or 10)
    npc = Character.objects.create(
        ...
        strength=int(request.POST.get("npc_str", 50) or 50),
        constitution=int(request.POST.get("npc_con", 50) or 50),
        dexterity=int(request.POST.get("npc_dex", 50) or 50),
        intelligence=int(request.POST.get("npc_int", 50) or 50),
        power=int(request.POST.get("npc_pow", 50) or 50),
